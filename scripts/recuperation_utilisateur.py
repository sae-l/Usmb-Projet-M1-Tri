...
#recupere les information d'un fichier xlsx
...
def Recuperation_utilisateur(fichier,liste_groupe,serveur,user,mdp):
    ...
    for i in range(0,len(liste_ldap)):
        ...
        for j in range(0,len(liste_fichier)):
            if (liste_ldap[i][1] == liste_fichier[j][0]) and (liste_ldap[i][2] ==liste_fichier[j][1]):
    ...
    for k in range(0,len(liste_fichier)):
        ...
        for l in range(0,len(liste_utilisateur)):
            if (liste_utilisateur[l][1] == liste_fichier[k][0]) and (liste_utilisateur[l][2] == liste_fichier[k][1]):
                match_bool=True
